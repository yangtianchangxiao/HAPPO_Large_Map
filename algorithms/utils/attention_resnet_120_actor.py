...
class resnet(nn.Module):
    def __init__(self, dropout_prob):
        ...
        self.conv_local_view = nn.Conv2d(in_channels=1, out_channels=32, kernel_size=3, stride=2, padding=0) # input 9*9; output （9-2+2*0）/2+1=5
...
class Attention_model(nn.Module):
    def __init__(self, args, obs_shape):
        ...
        self.state_length = 60*60+19*19 # 19*19 is local_view_range
    def forward(self, x):
