...
from algorithms.utils.attention_dense import Attention_model as Attention_model_dense

from algorithms.utils.attention_resnet_120 import Attention_model as Attention_model_resnet_120
from algorithms.utils.attention_resnet_120_actor import Attention_model as Attention_model_resnet_120_actor
from algorithms.utils.attention_resnet_120_critic import Attention_model as Attention_model_resnet_120_critc
...
class Actor(nn.Module):
    ...
    def __init__(self, args, obs_space, action_space, device=torch.device("cpu")):
        ...
        elif args.nn_type == 'attention_dense':
            base = Attention_model_dense
        elif args.nn_type == 'attention_resnet_120':
            base = Attention_model_resnet_120
        elif args.nn_type == 'attention_resnet_120_actor_critic':
            base = Attention_model_resnet_120_actor
...
class Critic(nn.Module):
    ...
    def __init__(self, args, cent_obs_space, device=torch.device("cpu")):
        ...
        if args.nn_type == 'mlp':
            ...
            base = Attention_model_resnet_120_critc
